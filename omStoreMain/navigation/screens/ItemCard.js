...
const ItemCard = ({productName,productStatus,productForDelivery,productNameHindi,productCatagory, productSubCatagory,productCode,productSeller, productGST, productSelling, productDescription, productUrl, productPrice,  productDiscount, productID,ListImageURL, navigation}) => {
  ...
  return (
    ...
    <TouchableOpacity style={{width:'50%', padding:5, paddingEnd:5,paddingStart:0}} onPress={() => onitemClick()}>
